...
namespace PJATK_APBD_Cw4_s32103.Migrations
{
    ...
    [Migration("20260525220342_AddMissingPCComponentsSeed")]
    partial class AddMissingPCComponentsSeed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s32103.Entities.Component", b =>
                {
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s32103.Entities.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s32103.Entities.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s32103.Entities.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s32103.Entities.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s32103.Entities.Component", b =>
                {
                    b.HasOne("PJATK_APBD_Cw4_s32103.Entities.ComponentManufacturer", "ComponentManufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturersId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PJATK_APBD_Cw4_s32103.Entities.ComponentType", "ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("PJATK_APBD_Cw4_s32103.Entities.PCComponent", b =>
                {
                    b.HasOne("PJATK_APBD_Cw4_s32103.Entities.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PJATK_APBD_Cw4_s32103.Entities.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
